...
# Which sites to skip due to missing carbon data?
full_site_list = unique(rownames(all_predictors$mois))
has_pC = pC_plot[rowSums(!is.na(pC_plot)) > 0,]
pc_site_list = unique(substr(rownames(has_pC), 1, 4))
site_skip = setdiff(full_site_list, pc_site_list)
